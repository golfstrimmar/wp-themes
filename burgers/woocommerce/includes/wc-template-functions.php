...
echo 'iiiiiiiiiiiiiiiiiiiii';
		// echo '<a href="' . esc_url( $link ) . '" class="product-card__link  woocommerce-LoopProduct-link woocommerce-loop-product__link">';;
		// echo '<a href="' . esc_url( $link ) . '" class="woocommerce-LoopProduct-link woocommerce-loop-product__link  product-card__link popups-init-js">';
		// echo '	<a class="product-card__link popups-init-js" href="#!" rel="slide-1-popup"></a>';
	}
}
// =================================================
// =================================================
